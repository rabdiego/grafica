...
/**
 * Classe que representa uma fonte de luz ambiente.
 */
class AmbientSource : public LightSource
{
public:
	// Construtor, getDirection, computeIntensity e convertToCamera são métodos sobrescritos da classe LightSource.
